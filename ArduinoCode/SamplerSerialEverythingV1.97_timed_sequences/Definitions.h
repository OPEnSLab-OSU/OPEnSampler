...
struct config_t
{
  ...
  uint16_t FDMs; // Flush duration in ms
  uint16_t SDMs;  // Sample Duration in ms
  ...
  uint16_t BDDMs; //bag draw duration in ms
  uint16_t BFDMs; //bag flush duration in ms
} configuration;
...
//----------------------------
// Function action and time arrays - set defaults
//----------------------------
...
uint16_t myTimes[] =
{
  MIN_FUNC_TIME, FLUSH_DUR_MS_DEF, MIN_FUNC_TIME,
  MIN_FUNC_TIME, 1, BAG_FLUSH_DUR_MS_DEF, BAG_DRAW_DUR_MS_DEF, MIN_FUNC_TIME,
  MIN_FUNC_TIME, FLUSH_DUR_MS_DEF, MIN_FUNC_TIME,
  MIN_FUNC_TIME, 1, BAG_FLUSH_DUR_MS_DEF, BAG_DRAW_DUR_MS_DEF, MIN_FUNC_TIME,
  MIN_FUNC_TIME, FLUSH_DUR_MS_DEF, MIN_FUNC_TIME,
  MIN_FUNC_TIME, BAG_DRAW_DUR_MS_DEF,
  SAMPLE_DUR_MS_DEF, MIN_FUNC_TIME
};
